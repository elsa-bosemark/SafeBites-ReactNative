...
//HYPOTHETICALLY< THIS WORKS BUT YOU HAVE TO PROVIDE A CREDIT CARD EVEN THOUGH IT DOESN"T COST MONEY.
  ...
  async getDirections(startLoc, destinationLoc) {
        try {
            let resp = await fetch(`https://maps.googleapis.com/maps/api/directions/json?origin=${ startLoc }&destination=${ destinationLoc }&key=AIzaSyCi0HQ1zcQmm8ZeKqFSNKkxq0yfWOt6nC8`)
