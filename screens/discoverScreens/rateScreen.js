      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <RateSlider
            ...
            text="There is enforcement and use of masks"
            maxVal={100}
            step={5}
          />
          <RateSlider
            ...
            text="Hand sanitizers are available"
            maxVal={100}
            step={5}
          />
          <RateSlider
            ...
            text="There are shields and/or physical barriers"
            maxVal={100}
            step={5}
          />
          <Spacer height={20} />
          ...
          >
            ...
            >
              <View style={curbsidePickup ? styles.yesTag : styles.tag}>
                <Text
                  style={{ ...styles.tagText, fontSize: 15, color: "white" }}
                >
                  Curbside Pickup
                </Text>
              </View>
